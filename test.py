...
# ALSO AS I SAID HERE IS ROUNDS, SO ITS COMMON THAT HERE IN LOWER ROUND LONG HASHES CANNOT BE OBTAINED
# FOR FIXING THIS PROBLEM I HAVE CREATED THOSE FUNCTIONS
# NOW FOR MAKING THINGS CLEAR, I AM PRESENTING SOME INFO ABOUT THIS HASH PROGRAM
